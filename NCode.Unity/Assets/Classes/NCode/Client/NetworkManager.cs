...
namespace NCode.Core.Client
{
    ...
    public class NetworkManager : MonoBehaviour
    {
        ...
        /// </summary>
        private static Utilities.List<NNetworkEntityLink> _networkEntityList = new Utilities.List<NNetworkEntityLink>();
        ...
        /// </summary>
        public static Guid ClientGuid { get { return Instance._mainClient.ClientGuid; } }
        ...
        void Update()
        {
            if (!Application.isPlaying)
            {
                if (_mainClient != null)
                {
                    _mainClient.ContinueUpdateThread = false;
                }
            }
        }
        ...
        public static bool Connect(string ip, int port)
        {
            ...
            Instance._mainClient.StartUpdateThread();
            return true;
        }
