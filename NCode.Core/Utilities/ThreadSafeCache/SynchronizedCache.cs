...
{
    #region SynchronizedCache<T> class
    /// <summary>
    ...
    /// SynchronizedCache is thread safe and will delete expired entries on its own using System.Threading.Timers (which run on <see cref="ThreadPool"/> threads).
    /// Source: https://www.codeproject.com/Articles/1033606/SynchronizedCache-T-A-threadsafe-Simple-Efficient-Generic-In-m
    /// </summary>
    public class SynchronizedCache<K, T> : IDisposable
    {
        #region Constructor and class members
        /// <summary>
        /// Initializes a new instance of the <see cref="SynchronisedSynchronisedCache{K,T}"/> class.
        /// </summary>
    ...
    #region Other SynchronizedCache classes (derived)
    /// <summary>
    ...
    /// SynchronizedCache is thread safe and will delete expired entries on its own using System.Threading.Timers (which run on <see cref="ThreadPool"/> threads).
    /// </summary>
    public class SynchronizedCache<T> : SynchronizedCache<string, T>
    {
    }

    /// <summary>
    /// The non-generic SynchronizedCache class instanciates a SynchronizedCache{object} that can be used with any type of (mixed) contents.
    ...
    /// </summary>
    public class SynchronizedCache : SynchronizedCache<string, object>
    {
        #region Static Global SynchronizedCache instance 
        private static Lazy<SynchronizedCache> global = new Lazy<SynchronizedCache>();
        /// <summary>
        ...
        /// </value>
        public static SynchronizedCache Global => global.Value;
        #endregion
    }
    #endregion
