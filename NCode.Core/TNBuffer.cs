...
namespace NCode.Core
{
    ...
    public class Buffer
    {
        static Utilities.List<Buffer> mPool = new Utilities.List<Buffer>();
	...
	static void Log (string text)
	{
        ...
        static public void Recycle(Utilities.List<Buffer> list)
        {
#if RECYCLE_BUFFERS
            lock (mPool)
            {
        ...
        static public void Recycle(Utilities.List<Datagram> list)
        {
#if RECYCLE_BUFFERS
            lock (mPool)
            {
