    ...
    public static class BinaryExtensions
    {
...
#endif
                case 50: writer.Write((V3)obj); break;
                case 51: writer.Write((PlayerInfo)obj); break;
            }
        }
        ...
        public static object ReadObject(this BinaryReader reader)
        {
            ...
            switch (prefix)
            {
                ...
                case 51: return reader.ReadPlayerInfo();
            }
            return null;
        }
...
#endif
            if (type == typeof(V3)) return 50;
            if (type == typeof(PlayerInfo)) return 51;
            return 0;
        }
...
#endif
                case 50: return typeof(V3);
                case 51: return typeof(PlayerInfo);
            }
            return null;
        }
        ...
        public static void Write(this BinaryWriter writer, V3 v3)
        {
            if(v3 != null)
            {
                writer.Write(v3.X);
        ...
        public static void Write(this BinaryWriter writer, PlayerInfo info)
        {
            if (info != null)
            {
                writer.WriteByteArray(NConverters.ConvertObjectToByteArray(info));
            }
        }
        ...
        public static V3 ReadV3(this BinaryReader reader)
        {
            V3 v3 = new V3(reader.ReadSingle(), reader.ReadSingle(), reader.ReadSingle());
            if (v3 != null) return v3;
            return V3.Zero();
        }
        public static PlayerInfo ReadPlayerInfo(this BinaryReader reader)
        {
            PlayerInfo info = (PlayerInfo)NConverters.ConvertByteArrayToObject(reader.ReadByteArray());
