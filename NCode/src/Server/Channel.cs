...
namespace NCode
{
    ...
    {
        public static Utilities.List<Channel> Channels = new Utilities.List<Channel>();
        ...
        //Channel Range
        public V3 point00; //Bottom Left
        public V3 point01; //Top Left
        public V3 point10; //Bottom Right
        public V3 point11; //Top Right

        public int ID = 0;
        public Dictionary<Guid, NetworkObject> ChannelObjects = new Dictionary<Guid, NetworkObject>(); 
        public Utilities.List<NTcpPlayer> Players = new Utilities.List<NTcpPlayer>();
        ...
        /// </summary>
        public static void DisconnectPlayer(NTcpPlayer player)
        {
        ...
        public static void UpdateChannelObject(NetworkObject networkObject)
        {
            ...
            Utilities.List<Guid> PlayersWeHaveSentTo = new Utilities.List<Guid>(); 
        ...
        /// </summary>
        public static Utilities.List<Channel> GetConnectedChannels (NTcpPlayer player)
        {
            Utilities.List<Channel> channels = new Utilities.List<Channel>();
        ...
        public bool RemovePlayer(NTcpPlayer player)
        {
            if (IsPlayerConnected(player))
            {
                ...
                Utilities.List<KeyValuePair<Guid, NetworkObject>> objectsToRemove = new Utilities.List<KeyValuePair<Guid, NetworkObject>>();
